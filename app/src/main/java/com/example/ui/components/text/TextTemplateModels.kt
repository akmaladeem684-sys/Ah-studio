...
val ALL_TEXT_TEMPLATES: List<TextTemplateItem> = listOf(
  // 1. Trending 🔥 (Rich Suite of Real Animated Viral Text Templates)
  TextTemplateItem(
    id = "trend_glow_pop",
  ...
  TextTemplateItem(
    id = "trend_cyber_neon_glow",
    name = "Cyber Neon Flicker",
    category = "Trending",
    sampleText = "NEON DREAMS ⚡",
    fontFamily = "Futuristic",
    fontSizeSp = 30f,
    fontWeight = 900,
    textColor = 0xFF00F0FF,
    hasShadow = true,
    shadowColor = 0xFF00E5FF,
    shadowBlur = 12f,
    strokeWidth = 1.5f,
  ...
  TextTemplateItem(
    id = "trend_3d_hyper_pop",
    name = "3D Hyper Pop",
    category = "Trending",
    sampleText = "EXPLOSIVE HIT 💥",
    fontFamily = "Impact",
    fontSizeSp = 34f,
    fontWeight = 900,
  ...
  TextTemplateItem(
    id = "trend_cinematic_gold",
    name = "Cinematic Luxury Gold",
    category = "Trending",
    sampleText = "MASTERPIECE 👑",
    fontFamily = "Playfair",
    fontSizeSp = 30f,
    fontWeight = 700,
    letterSpacing = 2.5f,
  ...
  TextTemplateItem(
    id = "trend_glitch_vhs",
    name = "Cyberpunk Glitch VHS",
    category = "Trending",
    sampleText = "GLITCH PROTOCOL 👾",
  ...
  TextTemplateItem(
    id = "trend_typewriter_matrix",
    name = "Matrix Code Terminal",
    category = "Trending",
    sampleText = "> INITIALIZING_AI 💻",
    fontFamily = "Monospace",
    fontSizeSp = 26f,
    fontWeight = 800,
    textColor = 0xFF22C55E,
    hasBackground = true,
    backgroundColor = 0xEE052E16,
    cornerRadius = 8f,
    bgPadding = 14f,
    strokeWidth = 1.5f,
  ...
  TextTemplateItem(
    id = "trend_bubble_pastel",
    name = "Pastel Bubble Bounce",
    category = "Trending",
    sampleText = "Sweet Vibes Only 🌸",
    fontFamily = "Cursive",
    fontSizeSp = 28f,
    fontWeight = 800,
    textColor = 0xFFFFF0F5,
    hasBackground = true,
    backgroundColor = 0xDDFF69B4,
    cornerRadius = 24f,
    bgPadding = 16f,
    hasShadow = true,
    shadowColor = 0x66FF1493,
    animationType = "Bounce",
    animDurationMs = 550L,
    badgeEmoji = "🌸"
  ),
  TextTemplateItem(
    id = "trend_viral_hook_alert",
    name = "Viral Hook Alert",
    category = "Trending",
  ...
  TextTemplateItem(
    id = "trend_hologram_aurora",
    name = "Aurora Holographic",
    category = "Trending",
    sampleText = "FUTURE VISION ✨",
    fontFamily = "Montserrat",
    fontSizeSp = 29f,
    fontWeight = 900,
  ...
  TextTemplateItem(
    id = "trend_esports_strike",
    name = "Esports Rage Strike",
    category = "Trending",
    sampleText = "KILLER STREAK 🎮",
    fontFamily = "Bebas",
    fontSizeSp = 32f,
    fontWeight = 900,
  ...
  TextTemplateItem(
    id = "trend_minimal_slide",
    name = "Clean Modern Lower Third",
    category = "Trending",
    sampleText = "CREATOR HIGHLIGHT 🎬",
    fontFamily = "Montserrat",
    fontSizeSp = 24f,
    fontWeight = 800,
  ...
  TextTemplateItem(
    id = "trend_retro_synthwave",
    name = "Retro 80s Synthwave",
    category = "Trending",
    sampleText = "SYNTHWAVE 1984 📼",
    fontFamily = "Impact",
    fontSizeSp = 30f,
    fontWeight = 900,
    textColor = 0xFFFF007F,
    hasGradient = true,
    gradientColorStart = 0xFFFF007F,
    gradientColorEnd = 0xFFFF9900,
    strokeWidth = 2.5f,
    strokeColor = 0xFF1E1B4B,
    hasShadow = true,
  ...
  TextTemplateItem(
    id = "trend_vlog_cozy_glow",
    name = "Aesthetic Vlog Title",
    category = "Trending",
    sampleText = "sunday morning ☕ vlog",
    fontFamily = "Playfair",
    fontSizeSp = 26f,
    fontWeight = 700,
    isItalic = true,
  ...
  TextTemplateItem(
    id = "trend_caption_punch",
    name = "High Contrast Subtitle",
    category = "Trending",
  ...
  TextTemplateItem(
    id = "trend_diamond_vip",
    name = "Diamond VIP Extrusion",
    category = "Trending",
    sampleText = "VIP EXCLUSIVE 💎",
    fontFamily = "Montserrat",
    fontSizeSp = 28f,
    fontWeight = 900,
    textColor = 0xFFE0F2FE,
    hasBackground = true,
    backgroundColor = 0xEE4C1D95,
    cornerRadius = 14f,
    bgPadding = 18f,
    strokeWidth = 2f,
    strokeColor = 0xFFA855F7,
    hasShadow = true,
    shadowColor = 0xFFC084FC,
    shadowBlur = 10f,
    animationType = "Blur",
    animDurationMs = 600L,
    isPremium = true,
