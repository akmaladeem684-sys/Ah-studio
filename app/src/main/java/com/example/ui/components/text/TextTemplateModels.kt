...
val ALL_TEXT_TEMPLATES: List<TextTemplateItem> = listOf(
  // 1. Trending 🔥 (Live and Actual Animated Text Templates with Real Editable Objects)
  TextTemplateItem(
    id = "trend_abc",
    name = "Abc 3D Bubble",
    category = "Trending",
    ...
    hasGradient = true,
    gradientColorStart = 0xFFFF5722,
    gradientColorEnd = 0xFFFF007F,
    strokeWidth = 3.5f,
  ...
  TextTemplateItem(
    id = "trend_text_simple",
    name = "Text Simple / Type Here",
    category = "Trending",
  ...
  TextTemplateItem(
    ...
    hasGradient = true,
    gradientColorStart = 0xFFFFE082,
    gradientColorEnd = 0xFFFFB300,
    hasShadow = true,
    ...
    animationIn = "Cinematic reveal",
    animDurationMs = 700L,
    badgeEmoji = "🎬"
  ),
  TextTemplateItem(
    id = "trend_awesome",
    name = "Awesome Pop Graffiti",
    category = "Trending",
    sampleText = "Awesome",
    fontFamily = "Impact",
    fontSizeSp = 36f,
  ...
  TextTemplateItem(
    id = "trend_have_a_question",
    name = "Have A Question Pill",
    category = "Trending",
    sampleText = "Have A Question / Comment / Or Topic Idea?",
    fontFamily = "Montserrat",
    fontSizeSp = 20f,
    fontWeight = 700,
    textColor = 0xFFFFFFFF,
  ...
  TextTemplateItem(
    ...
    letterSpacing = 3f,
    isAllCaps = true,
    textColor = 0xFF00E676,
    hasGradient = true,
    gradientColorStart = 0xFF00E676,
    gradientColorEnd = 0xFFFFD700,
    strokeWidth = 2.5f,
    strokeColor = 0xFF004D40,
    hasGlow = true,
    ...
    animationIn = "Glow pulse",
    animDurationMs = 600L,
    badgeEmoji = "🍀"
  ),
  TextTemplateItem(
    id = "trend_best_highlight",
    name = "Best Highlight Of The Year",
    category = "Trending",
    sampleText = "Best Highlight Of The Year",
    fontFamily = "Playfair",
    fontSizeSp = 26f,
    fontWeight = 700,
    isItalic = true,
    ...
    hasGradient = true,
    gradientColorStart = 0xFFFFF8E1,
    gradientColorEnd = 0xFFFFD54F,
    hasShadow = true,
    shadowColor = 0xAA000000,
    shadowBlur = 6f,
    animationType = "Cinematic reveal",
  ...
  TextTemplateItem(
    id = "trend_sunshine_mind",
    name = "Sunshine On My Mind",
    category = "Trending",
    sampleText = "Sunshine On My Mind",
    fontFamily = "Cursive",
    fontSizeSp = 30f,
    fontWeight = 700,
    textColor = 0xFFFFEE58,
    hasGradient = true,
    gradientColorStart = 0xFFFFEE58,
    gradientColorEnd = 0xFFFFA000,
    hasShadow = true,
    shadowColor = 0x88D97706,
    shadowBlur = 6f,
    animationType = "Bounce",
    animationIn = "Bounce",
    animDurationMs = 550L,
  ...
  TextTemplateItem(
    id = "trend_minimal_mode",
    name = "Minimal Mode Terminal",
    category = "Trending",
  ...
  TextTemplateItem(
    id = "trend_new_episode",
    name = "New Episode Broadcast",
    category = "Trending",
    ...
    animationIn = "Neon pulse",
    animDurationMs = 550L,
    badgeEmoji = "🎙️"
  ),
  TextTemplateItem(
    id = "trend_stories",
    name = "Stories Aesthetic",
    category = "Trending",
    sampleText = "Stories",
    fontFamily = "Cursive",
    fontSizeSp = 34f,
    fontWeight = 700,
    textColor = 0xFFE9D5FF,
    hasGradient = true,
    gradientColorStart = 0xFFE9D5FF,
    gradientColorEnd = 0xFFC084FC,
    hasShadow = true,
    shadowColor = 0x887E22CE,
    shadowBlur = 8f,
    animationType = "Blur",
    animationIn = "Blur",
    animDurationMs = 600L,
  ...
  TextTemplateItem(
    ...
    shadowColor = 0xDD000000,
    shadowBlur = 8f,
    animationType = "Character reveal",
    animationIn = "Character reveal",
    animDurationMs = 750L,
    badgeEmoji = "🎬"
  ),
  TextTemplateItem(
    id = "trend_viral",
    name = "Viral Cyber Fire",
    category = "Trending",
    sampleText = "VIRAL",
  ...
  TextTemplateItem(
    ...
    secondaryLayers = listOf(
      TextLayerConfig(
        ...
        animationIn = "Slide",
        animDurationMs = 550L,
        animationDelayMs = 200L
      )
    )
  ),
  TextTemplateItem(
    id = "trend_angel",
    name = "Angel Ethereal Aura",
    category = "Trending",
    sampleText = "Angel",
    fontFamily = "Cursive",
    fontSizeSp = 36f,
  ...
  TextTemplateItem(
    ...
    shadowBlur = 8f,
    hasGlow = true,
    glowColor = 0xFFB71C1C,
    glowRadius = 10f,
    animationType = "Stroke reveal",
    animationIn = "Stroke reveal",
    animDurationMs = 550L,
    badgeEmoji = "💀"
  ),
  TextTemplateItem(
    id = "trend_unlocked",
    name = "Unlocked Trophy Badge",
    category = "Trending",
    sampleText = "UNLOCKED 🔓",
    fontFamily = "Impact",
    fontSizeSp = 30f,
    ...
    gradientColorEnd = 0xFFFF9100,
    strokeWidth = 2.5f,
    strokeColor = 0xFF3E2723,
    hasGlow = true,
  ...
  TextTemplateItem(
    id = "trend_half_time",
    name = "Half Time Scoreboard",
    category = "Trending",
    sampleText = "HALF TIME ⏱️",
    fontFamily = "Bebas",
    fontSizeSp = 34f,
    fontWeight = 900,
    isItalic = true,
  ...
  TextTemplateItem(
    id = "trend_like_comment_share",
    name = "Like • Comment • Share",
    category = "Trending",
    sampleText = "Like • Comment • Share",
    fontFamily = "Montserrat",
    fontSizeSp = 20f,
    fontWeight = 800,
    textColor = 0xFFFFFFFF,
